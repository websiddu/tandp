		...
		<tr>
			...
			<td>
				<telerik:RadListBox ID="RadListBox1" runat="server" CheckBoxes="True" 
					DataKeyField="ID" DataSortField="Course1" DataSourceID="LinqDataSource1" 
					DataTextField="Course1" DataValueField="ID" Skin="Windows7"
			...
			<td>
				<telerik:RadListBox ID="RadListBox2" runat="server" CheckBoxes="True" 
					DataKeyField="ID" DataSortField="Department1" 
					DataSourceID="DepartmentsDataSource" DataTextField="Department1" 
					DataValueField="ID" Skin="Windows7" style="top: 0px; left: 0px; width: 227px"
                    onclientitemchecked="onItemChecked"
					  AppendDataBoundItems="true"
				...
				<asp:LinqDataSource ID="DepartmentsDataSource" runat="server" 
					ContextTypeName="Datbase_ClassesDataContext" EntityTypeName="" 
